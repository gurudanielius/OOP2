...
void output(vector<Stud> v1) {
    ...
    for (int i=0; i<v1.size(); i++) {
        cout<<left<<setw(15)<<v1.at(i).vardas << "    "
            <<left<<setw(15)<<v1.at(i).pavarde << "    "
            <<left<<setw(15)<<fixed<<setprecision(2)<<v1.at(i).med << "    "
            <<left<<setw(15)<<fixed<<setprecision(2)<<v1.at(i).vid << "    "
            <<left<<setw(15)<<fixed<<setprecision(2)<<v1.at(i).rez<<"    "
            <<left<<setw(20)<<fixed<<setprecision(2)<<&v1.at(i)<<endl;;
    }
